# This is a modified version of the original app_functions.py file.
# The only modifiaction was the refactoring of the match statements since the app is hosted by pythonanywhere, which only supports python 3.9 (no match statements).
# At least so far I couldn't make it support 3.10...
